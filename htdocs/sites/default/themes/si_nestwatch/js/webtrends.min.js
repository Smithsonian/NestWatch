function WebTrends() {
    var that = this;
    this.dcsid = "dcs0pvvi0bdzpxb57pjoeipbp_2x6w";
...
WebTrends.prototype.dcsFPC = function() {
    ...
    if (!this.FPCConfig.enabled && !this.TPCConfig.enabled) this.WT["ce"] = "0"; else if (this.FPCConfig.enabled && !this.TPCConfig.enabled) this.WT["ce"] = "1"; else this.WT["ce"] = "2";
    ...
    var dCur = new Date();
    var adj = dCur.getTimezoneOffset() * 6e4 + this.timezone * 36e5;
    dCur.setTime(dCur.getTime() + adj);
    var dExp = new Date(dCur.getTime() + 31536e7);
    ...
    if (document.cookie.indexOf(name + "=") == -1) {
        ...
        WT.co_f = id;
        var dLst = new Date(lv);
        WT.vt_f_tlh = Math.floor((dLst.getTime() - adj) / 1e3);
        dSes.setTime(ss);
        if (dCur.getTime() > dLst.getTime() + 18e5 || dCur.getTime() > dSes.getTime() + 288e5) {
            WT.vt_f_tlv = Math.floor((dSes.getTime() - adj) / 1e3);
